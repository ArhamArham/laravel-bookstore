        		...
        		<div class="row">
        			<div class="col-lg-9 col-12">
        					...
        					<div class="row">
        						<div class="col-lg-6 col-12">
        							<div class="wn__fotorama__wrapper">
	        							<div class="fotorama wn__fotorama__action" data-nav="thumbs">
		        							  <a href="1.jpg"><img src='{{ URL::asset("public/images/books/$book->thumbnail.jpg")}}'' alt=""></a>
        						...
        						<div class="col-lg-6 col-12">
        							<div class="product__info__main">
										<form action="{{route('cart.store',$book)}}" method="post">
											@csrf
        								<h1>{{$book->name}}</h1>
						...
						<div class="wn__related__product pt--80 pb--50">
							...
							<div class="row mt--60">
								<div class=" product__style--3 row furniture--4 border--round arrows_style owl-carousel owl-theme row mt--50 owl-loaded owl-drag">
									@foreach ($books as $book)
									<div class="col-lg-3 col-md-4 col-sm-6 col-12 ">
										<div class="product__thumb">
											<a class="first__img" href='single_product/{{$book->id}}'><img src='{{ URL::asset("public/images/books/$book->thumbnail.jpg")}}' alt="product image"></a>
											<div class="hot__box">
        			...
        			<div class="col-lg-3 col-12 md-mt-40 sm-mt-40">
        				<div class="shop__sidebar">
        					...
        					<aside class="wedget__categories sidebar--banner">
								<img src="{{ URL::asset("public/images/others/banner_left.jpg")}}" alt="banner images">
								<div class="text">
									<h2>new products</h2>
